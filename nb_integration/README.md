...
<img src="https://github.com/yabinmeng/dse_mc_nb/blob/master/nb_integration/screenshots/nb_graphite_carbon.png" width=1200)
...
![grafana_nb_graphite_ds](./screenshots/grafana_graphite_ds.png){:height="50%" width="50%"}

![grafana_nb_dashboard](./screenshots/grafana_nb_dashboard.png){:height="50%" width="50%"}
